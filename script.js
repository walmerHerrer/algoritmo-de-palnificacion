...
function showGanttChart(output, outputDiv) {
    ...
    ganttChartHeading.innerHTML = "Grafico lineal de Gantt";
...
function showTimelineChart(output, outputDiv) {
    ...
    timelineChartHeading.innerHTML = "Gráfico de gantt";
...
function showFinalTable(input, output, outputDiv) {
    ...
    finalTableHeading.innerHTML = "Tabla de Resultados";
